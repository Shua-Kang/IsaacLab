...
parser.add_argument("--mass_low", type=float, default=0.05, help="Lower bound for mass initialization.")
parser.add_argument("--mass_high", type=float, default=0.05, help="Upper bound for mass initialization.")
