...
parser.add_argument("--video_interval", type=int, default=200000, help="Interval between video recordings (in steps).")
...
parser.add_argument("--exp-name", type=str, default=None, help="the name of the experiment")
parser.add_argument(
    "--track",
